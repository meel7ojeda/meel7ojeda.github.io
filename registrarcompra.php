...
require_once 'funciones/idautomaticoCOMPRA.php';

require_once 'funciones/archivoparacompra.php';


$query = "SELECT id_proveedor, proveedor FROM proveedor WHERE Disponibilidad = 1"; 
...
if (!empty($mensajeC)) {
    echo "<div class='mensaje-correcto'>$mensajeC   -  <b><a href=registrarCompra.php>Registrar otro compra</a></b></div>";
}
...
<div class="mdl-grid">
	<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
			...
			<form role="form"  method="POST"> 
                    ...
                    <?php echo htmlspecialchars($nuevoID); ?>
                    </label>
                    <!-- Si necesitas enviar este número al backend -->
                    <input type="hidden" name="id_compra" value="<?php echo htmlspecialchars($nuevoID); ?>">
                            </div>
...
<div class="mdl-cell mdl-cell--12-col">
    <h5><strong class="text-condensedLight"><i class="zmdi zmdi-border-color"></i> &nbsp; SELECCIONAR PROVEEDOR</strong></h5>
</div>
            ...
            fetch(`funciones/obtener_productos.php?proveedor=${encodeURIComponent(proveedor)}`)
                ...
                .then(data => {
                    data.forEach(producto => {
                        ...
                        option.setAttribute('data-precio', producto.precio_compra); // Incluye el precio como atributo
           ...
           if (!empty($_POST['FPago']) && $_POST['FPago'] ==  $ListadoJer[$i]['IDFP']) {
            ...
            <?php } ?>
									...
									<p class="text-center">
										...
										<div class="mdl-tooltip" for="btn-addClient">Registrar Compra</div>
									</p>
								</form>
