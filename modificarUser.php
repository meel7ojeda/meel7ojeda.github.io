...
require_once 'funciones/actualizarUser.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST['accion'] === 'modificar') {
        ...
        $resultado = ModificarUser($MiConexion, $_POST);
...
require_once 'funciones/UserPorDNI.php';

if (isset($_GET['DNI'])) {
    $dni = $_GET['DNI'];
   
    $cliente = obtenerDatosUsersPorDNI($dni); 
...
if (!empty($mensajeC)) {
    echo "<div class='mensaje-correcto'>$mensajeC    -  <b><a href=users.php>Volver</a></b></div>";
    }
...
?>
			...
			<input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="DNI" name="DNI" value="<?php echo htmlspecialchars($dni); ?>" readonly>
									    ...
									    <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text"  id="NombreUser" name="NombreUser" value="<?php echo htmlspecialchars($nombre); ?>">
									    ...
									    <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text"  id="ApellidoUser" name="ApellidoUser" value="<?php echo htmlspecialchars($apellido); ?>">
									    ...
									    <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" id="DomicilioUser" name="DomicilioUser" value="<?php echo htmlspecialchars($domicilio); ?>">
									    ...
									    <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" id="CiudadUser" name="CiudadUser" value="<?php echo htmlspecialchars($ciudad); ?>">
           ...
           if (!empty($_POST['Provincia']) && $_POST['Provincia'] ==  $ListadoProvincia[$i]['IDPROV']) {
            ...
            <?php } ?>
									    ...
									    <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="tel"  id="ContactoUser" name="ContactoUser" value="<?php echo htmlspecialchars($contacto); ?>">
									    ...
									    <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="email" id="EmailUser" name="EmailUser" value="<?php echo htmlspecialchars($email); ?>">
									...
									<p class="text-center">
										...
										<div class="mdl-tooltip" for="btn-addClient">Modificar Usuario</div>
									</p>
								</form>
